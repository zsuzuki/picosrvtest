    ...
    { //Press the button
            ...
            sTP_Draw.Ypoint < sLCD_DIS.LCD_Dis_Page)
        {
            ...
            else
            {
                ...
                else if (sTP_Draw.Xpoint > 0 && sTP_Draw.Xpoint < 20 &&
                         sTP_Draw.Ypoint > 0 && sTP_Draw.Ypoint < 20)
                {
                    sTP_Draw.Color = BLUE;
                }
                else if (sTP_Draw.Xpoint > 20 && sTP_Draw.Xpoint < 40 &&
                         sTP_Draw.Ypoint > 0 && sTP_Draw.Ypoint < 20)
                {
                    sTP_Draw.Color = GREEN;
                }
                else if (sTP_Draw.Xpoint > 40 && sTP_Draw.Xpoint < 60 &&
                         sTP_Draw.Ypoint > 0 && sTP_Draw.Ypoint < 20)
                {
                    sTP_Draw.Color = RED;
                }
                else if (sTP_Draw.Xpoint > 60 && sTP_Draw.Xpoint < 80 &&
                         sTP_Draw.Ypoint > 0 && sTP_Draw.Ypoint < 20)
                {
                    sTP_Draw.Color = YELLOW;
                }
                else if (sTP_Draw.Xpoint > 80 && sTP_Draw.Xpoint < 100 &&
                         sTP_Draw.Ypoint > 0 && sTP_Draw.Ypoint < 20)
                {
                    sTP_Draw.Color = BLACK;
                }
...
void TP_GetTouch(uint16_t *x, uint16_t *y, bool *press)
{
    *x = sTP_Draw.Xpoint;
    *y = sTP_Draw.Ypoint;
    *press = (sTP_DEV.chStatus & TP_PRESS_DOWN) != 0;
}
